      ...
      {userRole === "teacher" ? (
        ...
        <>
          ...
          >
            <FaCalendarAlt className="text-purple-500 text-3xl mb-2" />
            <span className="text-3xl font-extrabold text-black">{stats.sessionsGiven ?? 0}</span>
            <span className="text-gray-700 mt-1 font-medium">Sessions Attended</span>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05, boxShadow: "0 8px 32px #60a5fa33" }}
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <FaUserGraduate className="text-blue-500 text-3xl mb-2" />
            <span className="text-3xl font-extrabold text-black">{stats.educatorCount ?? 0}</span>
            <span className="text-gray-700 mt-1 font-medium">Educators</span>
          </motion.div>
        </>
      )}
    </div>
