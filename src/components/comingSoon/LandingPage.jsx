...
export default function LandingPage({ user, userRole }) {
  ...
  return (
    <div className="min-h-screen w-screen max-w-screen min-w-screen   flex flex-col relative bg-gradient-to-br from-indigo-300/50 via-purple-200/30 to-pink-300/30 overflow-x-hidden items-center justify-center ">
      <Suspense fallback={null}>
        <div className="fixed inset-0 z-0 pointer-events-none w-screen">
          <div className="absolute top-0 left-0 w-fit h-fit bg-gradient-to-br from-blue-300/40 via-purple-200/30 to-pink-300/40 rounded-full blur-3xl animate-blob"></div>
          <div className="absolute bottom-0 right-0 w-fit h-fit bg-gradient-to-br from-pink-300/40 via-blue-200/30 to-purple-300/40 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute top-1/2 left-1/2 w-fit h-fit bg-gradient-to-br from-indigo-300/30 via-white/10 to-blue-300/30 rounded-full blur-2xl animate-blob animation-delay-4000"></div>
        </div>
      </Suspense>
