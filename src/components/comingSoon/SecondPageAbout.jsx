...
export default function SecondPageAbout({ achievements = [] }) {
  ...
  return (
    ...
    >
      <h2 className="text-xl md:text-2xl font-extrabold text-center mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
        “Knowledge grows when shared. Every skill you master is a spark waiting to ignite someone else’s journey.”
      </h2>
      <p className="text-gray-700 text-center text-sm md:text-base mb-6 md:mb-10 max-w-xl mx-auto">
